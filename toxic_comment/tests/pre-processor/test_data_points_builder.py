...
class TestDataPointsBuilder(unittest.TestCase):
    def test_build_and_get_train_data_points(self):
        train_path = "/home/mrohatgi/PycharmProjects/toxicComment/toxic_comment/data/train.csv"
        test_path = "/home/mrohatgi/PycharmProjects/toxicComment/toxic_comment/data/test.csv"
